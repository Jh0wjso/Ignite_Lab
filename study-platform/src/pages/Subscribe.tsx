        ...
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
            ...
            <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
                ...
                <div className="max-w-[640px">
                    ...
                    <p className="mt-4 text-gray-400 leading-relaxeds">
                        Em poucos dias você aprenderá uma das tecnologias mais ultilizadas no mercado de trabalho.
                    </p>
                </div>
             ...
             <img src="./src/assets/mocap.png" className="mt-10" alt="Mocap Image" />
